...
public class FavoritesActivityPre extends AppCompatActivity {
    ...
    private final EarthViewAdapter.OnItemClickListener onItemClickListener = new EarthViewAdapter.OnItemClickListener() {
        ...
        public void onItemClick(View view, int position) {
            ...
            if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                ...
                wallActivity = new Intent(FavoritesActivityPre.this, WallpaperActivity.class);
                ...
                ActivityOptionsCompat compat = ActivityOptionsCompat.makeSceneTransitionAnimation(FavoritesActivityPre.this, wallpaperImage);
                startActivity(wallActivity, compat.toBundle());

            } else {
                wallActivity = new Intent(FavoritesActivityPre.this, WallpaperActivityPre.class);
                wallActivity.putExtra(WallpaperActivity.WALLPAPER_OBJECT, earthWallpaper);
